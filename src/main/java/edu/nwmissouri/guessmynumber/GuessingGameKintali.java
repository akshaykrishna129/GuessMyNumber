 ...
 * @author Denise Case
 */
public class GuessingGameKintali {

    public static void main(String[] args) {
        // TODO: change computerNumber to secretNumber Hint: Right-click / Refactor / Rename
        int personallnumber = (int) (Math.random() * 100 + 1);
        int userAnswer = 0;
        System.out.println("The correct guess would be " + personallnumber);
        int count = 1;

        while (userAnswer != personallnumber) {
            ...
            JOptionPane.showMessageDialog(null, "" + calculateMessage(userAnswer, personallnumber, count));
            count++;
        }
    }
